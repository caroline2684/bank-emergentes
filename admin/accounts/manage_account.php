...
<div class="card card-outline card-primary">
        ...
        <div class="container-fluid">
            <form id="account-form">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <label class="control-label">Tercer Nombre</label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group m-0 p-0  col-sm-6">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-primary" type="button" id="generate_pass">Generar</button>
                        </div>
                    </div>
                </div>
                <?php if(!isset($id)): ?>
    ...
    <div class="card-footer">
        <div class="d-flex w-100">
            <button form="account-form" class="btn btn-primary mr-2">Guardar</button>
            <a href="./?page=accounts" class="btn btn-default">Cancelar</a>
        </div>
    </div>
</div>
<script>
