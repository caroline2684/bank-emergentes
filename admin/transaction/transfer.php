...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="container-fluid">
            <form id="account-form">
                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        <div class="form-group">
                            <label class="control-label">Number de Cuenta</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Transferir a</label>
                ...
                <hr>
                <div class="form-group">
                    <label class="control-label">Cantidad de deposito</label>
    ...
    <div class="card-footer">
        <div class="d-flex w-100">
            <button form="account-form" class="btn btn-primary mr-2">Enviar</button>
            <a href="./?page=transaction" class="btn btn-default">Cancelar</a>
        </div>
    </div>
</div>
<script>
